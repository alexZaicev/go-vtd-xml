...
// const (
// 	UniCharSize    uint32 = 0x10000
// 	XmlValid       uint32 = 0x01
// 	XmlSpace       uint32 = 0x02
// 	XmlNameStart   uint32 = 0x04
// 	XmlName        uint32 = 0x08
// 	XmlPubId       uint32 = 0x10
// 	XmlContent     uint32 = 0x20
// 	XmlNcNameStart uint32 = 0x40
// 	XmlNcName      uint32 = 0x80
// )
...
// 		{0x0009, 0x0009},
// 	}
// 	xmlSpaceChar     = []uint32{0x0020, 0x0009, 0x000D, 0x000A}
// 	xmlNameChar      = []uint32{0x002D, 0x002E}
// 	xmlNameStartChar = []uint32{0x003A, 0x005F}
// 	xmlPubIdChar     = []uint32{0x000A, 0x000D, 0x0020, 0x0021, 0x0023, 0x0024, 0x0025, 0x003D, 0x005F}
// 	xmlPubIdRange    = [][]uint32{
// 		{0x0027, 0x003B},
// 		{0x003F, 0x005A},
// 		{0x0061, 0x007A},
// 	}
// 	xmlLetterRange = [][]uint32{
// 		// BaseChar
...
// 		0x3007}
//
// 	xmlCombiningCharRange = [][]uint32{{0x0300, 0x0345},
...
//
// 	xmlCombiningCharChar = []uint32{0x05BF, 0x05C4, 0x0670, 0x093C, 0x094D,
...
//
// 	xmlDigitRange = [][]uint32{{0x0030, 0x0039}, {0x0660, 0x0669},
...
// 		{0x0F20, 0x0F29}}
//
// 	xmlExtenderRange = [][]uint32{{0x3031, 0x3035}, {
// 		0x309D, 0x309E}, {
// 		0x30FC, 0x30FE}}
// 	xmlExtenderChar = []uint32{0x00B7, 0x02D0, 0x02D1, 0x0387, 0x0640, 0x0E46, 0x0EC6, 0x3005}
//
// 	xmlSpecialChar = []uint32{'<', '&', ']'}
// )

const (
	XmlCharArraySize      = 0x10F7FD
	XmlSpaceCharArraySize = 0x4
)
